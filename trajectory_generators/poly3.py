...
class Poly3(TrajectoryGenerator):
    def __init__(self, start_q, desired_q, T):
        ...
        """
        self.a_0 = self.q_0
        self.a_1 = 3.0 * self.q_0
        self.a_2 = 3.0 * self.q_k
        self.a_3 = self.q_k
    ...
    def generate(self, t):
        ...
        q_dot =  3.0 * self.a_3 * t ** 2 + self.a_2 * (2.0 * t - 3.0 * t ** 2) + self.a_1 * (1.0 - 4.0 * t + 3.0 * t ** 2) + self.a_0 * (-3.0 + 6.0 * t - 3.0 * t ** 2)
        q_ddot = 6.0 * self.a_3 * t + self.a_2 * (2.0 - 6.0 * t) + self.a_1 * (-4.0 + 6.0 * t) + self.a_0 * (6.0 - 6.0 * t)
